...
```{r apiKey1, include=FALSE}
a <- booli("rbooliblog", "UBmptOLYsZ1Zlnd7cUO796SZeyluNP9TjWQ3c01m")
```
 
 
```{r setupKey1, eval=FALSE, include=TRUE}
...
```{r getListings1, eval=FALSE, include=TRUE}
knitr::opts_chunk$set(
	echo = TRUE,
	message = TRUE,
	warning = TRUE
